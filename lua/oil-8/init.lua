...
local function setup(_3fconfig)
  ...
  if config.integrations.enabled then
    ...
    if config.integrations.treesitter then
      for name_2_auto, args_3_auto in pairs({["@comment.error"] = {bold = true, fg = "#f35e7c", reverse = true}, ["@comment.note"] = {bold = true, fg = "#58e9ca", reverse = true}, ["@comment.warning"] = {bold = true, fg = "#f38f5e", reverse = true}, ["@constant.builtin"] = {link = "Boolean"}, ["@constant.macro"] = {fg = "#fe7c8d"}, ["@constructor"] = {link = "@punctuation"}, ["@keyword.export"] = {fg = "#fc83c5"}, ["@tag"] = {link = "Type"}, ["@tag.attribute"] = {link = "@variable.member"}, ["@tag.builtin"] = {link = "@type.builtin"}, ["@tag.delimiter"] = {link = "htmlTag"}, ["@type.builtin"] = {fg = "#c0a0ff"}, ["@variable"] = {fg = "#a4b6fe"}, ["@variable.builtin"] = {fg = "#84cfdd"}, ["@variable.member"] = {link = "Identifier"}}) do
        hi(0, name_2_auto, args_3_auto)
      end
      return nil
    else
