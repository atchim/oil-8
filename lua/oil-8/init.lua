...
local function setup(_3fconfig)
  ...
  if config.integration then
    ...
    if config.integration.treesitter then
      for name_2_auto, args_3_auto in pairs({["@comment.error"] = {bold = true, fg = "#f35e7c", reverse = true}, ["@comment.note"] = {bold = true, fg = "#58e9ca", reverse = true}, ["@comment.warning"] = {bold = true, fg = "#f38f5e", reverse = true}, ["@constant.builtin"] = {link = "Boolean"}, ["@constant.macro"] = {fg = "#fe7c8d"}, ["@constructor"] = {link = "@punctuation"}, ["@keyword.export"] = {fg = "#fc83c5"}, ["@string.documentation"] = {fg = "#6ceaa7"}, ["@string.regex"] = {fg = "#6ceaa7"}, ["@string.regexp"] = {link = "@string.regex"}, ["@tag"] = {link = "Type"}, ["@tag.attribute"] = {link = "@variable.member"}, ["@tag.builtin"] = {link = "@type.builtin"}, ["@tag.delimiter"] = {link = "htmlTag"}, ["@type.builtin"] = {fg = "#dd9ffe"}, ["@variable"] = {fg = "#a4b6fe"}, ["@variable.builtin"] = {fg = "#84cfdd"}, ["@variable.member"] = {link = "Identifier"}}) do
        hi(0, name_2_auto, args_3_auto)
      end
      return nil
    else
